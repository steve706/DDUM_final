...
class Prevent(data.Dataset):
    def __init__(self, root, channel=1, isTraining=True):
        super(Prevent, self).__init__()
    ...
    def get_dataPath(self, root, isTraining):
        ...
        """
        if isTraining:
            img_dir = os.path.join(root + "/original_images/original_images/train")
            gt_dir = os.path.join(root + "/segmented_images/segmented_images/train")
            deep_dir = os.path.join(root + "/segmented_images/segmented_images/train")
            superficial_dir = os.path.join(root + "/segmented_images/segmented_images/train")
        else:
            img_dir = os.path.join(root + "/original_images/original_images/test/")
            gt_dir = os.path.join(root + "/segmented_images/segmented_images/test/")
            deep_dir = os.path.join(root + "/segmented_images/segmented_images/test/")
            superficial_dir = os.path.join(root + "/segmented_images/segmented_images/test/")
