...
parser.add_argument("--dataset", type=str, default="rose", choices=["rose", "cria", "drive","rose-dvc","rose-svc","rose-all","OCTA500_3M","OCTA500_6M","rose-o","prevent"], help="dataset")  # choices可扩展
parser.add_argument("--mode", type=str, default="train", choices=["train", "test"], help="train or test")
# data settings
parser.add_argument("--data_dir", type=str, default="./data/ROSE/ROSE-1/SVC_DVC", help="path to folder for getting dataset")
...
parser.add_argument("--init_lr", type=float, default=0.0008, help="initial learning rate")
